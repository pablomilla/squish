...
function snapshot(): unknown {
  const { profile, targets, meals, days, favourites, unlocked, nutritionistNotes, look, outfit, scene, theme, comparisons } = useSquish.getState();
  return { profile, targets, meals, days, favourites, unlocked, nutritionistNotes, look, outfit, scene, theme, comparisons };
}
