...
function snapshot(): unknown {
  const { profile, targets, meals, days, favourites, plans, unlocked, nutritionistNotes, look, outfit, scene, shareDecor, theme, comparisons } = useSquish.getState();
  return { profile, targets, meals, days, favourites, plans, unlocked, nutritionistNotes, look, outfit, scene, shareDecor, theme, comparisons };
}
