...
function snapshot(): unknown {
  const { profile, targets, meals, days, favourites, plans, shopping, unlocked, nutritionistNotes, look, outfit, scene, shareDecor, theme, comparisons } = useSquish.getState();
